...
import org.jdiextractor.core.callstack.strategy.CallStackSnapshotExtractorWithMM;
 ...
 */
public class SnapshotCSExtractorWithMMLauncer extends AbstractLauncher {
	
	public static void main(String[] args) throws Exception {
		mainCore(args, CallStackSnapshotExtractorWithMM.class);
	}
